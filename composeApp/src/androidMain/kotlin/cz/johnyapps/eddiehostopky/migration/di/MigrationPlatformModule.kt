...
import cz.johnyapps.eddiehostopky.migration.domain.AndroidMigrateFrom0To1UseCase
...
actual val migrationPlatformModule = module {
    factoryOf(::AndroidMigrateFrom0To1UseCase) bind MigrateFrom0To1UseCase::class
}
